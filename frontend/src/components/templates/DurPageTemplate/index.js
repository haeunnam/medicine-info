...
import BucketModal from "../../molecules/BucketModal";
      ...
      <DurContainer labeld="DurSearch" type="text">
        ...
        <div>
          <div className="bucket">
            ...
            <Label className="bucket-button" children="복용중인 약" onClick={onBucketClick}/>
          </div>
        ...
        {isModalActive && (
          <BucketModal TakingMedicines={TakingMedicines} onModalOutsideClick={onModalOutsideClick} handleSelect={hadnleSelect} />
        )}
      </DurContainer>
